...
void dm_uds_read_did_result_callback(void *arg, unsigned short id, const unsigned char *data, unsigned int size);
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    service.rr_callid = dm_api_udsc_service_result_callback_set(om_api, udscid, dm_uds_read_did_result_callback, om_api/* 用户数据指针 */);
    /* ----------------------------------------------------------------- */
    /* ================================================================= */    
    /* 添加一个诊断请求 */
...
void dm_uds_request_transfer_callback(void *arg, unsigned short udscid, const unsigned char *msg, unsigned int msg_len, unsigned int sa, unsigned int ta, unsigned int tatype)
{
    ...
    dm_api_service_response(om_api, udscid, "\x62\xf1\x93\x02\x00", sizeof("\x62\xf1\x93\x02\x00") - 1, sa, ta, 0);
    /* ----------------------------------------------------------------- */
    /* ================================================================= */    
}
